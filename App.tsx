    ...
    return (
      <div className="w-full min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="z-10 text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">SENTINELA</h1>
          <p className="text-slate-400 text-lg max-w-xl mx-auto">
            Sistema Integrado de Emergência e Monitoramento de Segurança Pública
          </p>
        </div>

        <div className="z-10 grid md:grid-cols-2 gap-8 w-full max-w-4xl">
          {/* Card Cidadão */}
          <button 
            onClick={() => setSection('CITIZEN')}
            className="group relative bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-blue-500 rounded-2xl p-8 transition-all duration-300 text-left shadow-lg hover:shadow-blue-900/20"
          >
            ...
            <h2 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-400">App do Cidadão</h2>
          ...
          <button 
            ...
            className="group relative bg-slate-900 hover:bg-slate-800 border border-slate-700 hover:border-red-500 rounded-2xl p-8 transition-all duration-300 text-left shadow-lg hover:shadow-red-900/20"
          >
            ...
            <h2 className="text-2xl font-bold text-white mb-2 group-hover:text-red-400">Portal de Monitoramento</h2>
            <p className="text-slate-400 mb-6">
